...
$backup = "$footer.bak-bca-bigger-v3-$stamp"
$utf8NoBom = New-Object System.Text.UTF8Encoding($false)

Write-Host "==============================================================" -ForegroundColor Yellow
Write-Host " Footer - Perbesar HANYA Logo BCA (v3)" -ForegroundColor Yellow
Write-Host "==============================================================" -ForegroundColor Yellow
...
echo "BCA_BIGGER_V3_OK\n";
'@

$tmp = Join-Path $env:TEMP "bca-bigger-v3-$stamp.php"
...
Write-Host "Logo BCA sekarang maksimal 42x18 px." -ForegroundColor White
