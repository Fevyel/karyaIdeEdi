...
Write-Host " Fitur Loker Admin + Halaman Careers Dinamis (Resume v2)" -ForegroundColor Yellow
Write-Host "=============================================================" -ForegroundColor Yellow
...
if ((Test-Path $target) -and (([System.IO.Path]::GetFullPath($target)) -ne ([System.IO.Path]::GetFullPath($front)))) {
