...
$backup = "$footer.bak-bca-bigger-v5-$stamp"
$utf8NoBom = New-Object System.Text.UTF8Encoding($false)

Write-Host "==============================================================" -ForegroundColor Yellow
Write-Host " Footer - Perbesar HANYA Logo BCA (v5)" -ForegroundColor Yellow
Write-Host "==============================================================" -ForegroundColor Yellow
...
echo "BCA_BIGGER_V5_OK\n";
'@

$tmp = Join-Path $env:TEMP "bca-bigger-v5-$stamp.php"
...
Write-Host "Logo BCA sekarang maksimal 56x23 px." -ForegroundColor White
