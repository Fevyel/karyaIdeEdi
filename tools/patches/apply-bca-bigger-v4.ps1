...
$backup = "$footer.bak-bca-bigger-v4-$stamp"
$utf8NoBom = New-Object System.Text.UTF8Encoding($false)

Write-Host "==============================================================" -ForegroundColor Yellow
Write-Host " Footer - Perbesar HANYA Logo BCA (v4)" -ForegroundColor Yellow
Write-Host "==============================================================" -ForegroundColor Yellow
...
echo "BCA_BIGGER_V4_OK\n";
'@

$tmp = Join-Path $env:TEMP "bca-bigger-v4-$stamp.php"
...
Write-Host "Logo BCA sekarang maksimal 48x20 px." -ForegroundColor White
